        ...
        private void AddGrade(object sender, EventArgs e)
        {
            ...
            switch (tabControl1.SelectedIndex)
            {
                ...
                case 2:
                    ...
                    dataGridView1.DataSource = year2Sem1;
                    break;
                case 3:
                    dataGridView2.DataSource = null;
                    year2Sem2.Add(newCourse);
                    dataGridView2.DataSource = year2Sem2;
                    break;
                case 4:
                    dataGridView3.DataSource = null;
                    year2Sem3.Add(newCourse);
                    dataGridView3.DataSource = year2Sem3;
                    break;
                case 5:
                    dataGridView4.DataSource = null;
                    year3Sem1.Add(newCourse);
                    dataGridView4.DataSource = year3Sem1;
                    break;
                case 6:
                    dataGridView5.DataSource = null;
                    year3Sem2.Add(newCourse);
                    dataGridView5.DataSource = year3Sem2;
                    break;
                case 7:
                    dataGridView6.DataSource = null;
                    year4Sem1.Add(newCourse);
                    dataGridView6.DataSource = year4Sem1;
                    break;
                case 8:
                    dataGridView7.DataSource = null;
                    year4Sem2.Add(newCourse);
                    dataGridView7.DataSource = year4Sem2;
                    break;
            }
        }
